...
"""
    This is unittest for testing the class Client.
"""
...
class TestClient(unittest.TestCase):
    ...
    def test_client_put(self):
        ...
        for metric, value, timestamp in metrics_for_put:
            try:
                ...
                message = exp.args[0]
                self.fail(f"Error call client.put("
    ...
    def test_client_get_key(self):
        try:
            ...
            message = exp.args[0]
            self.fail(f"Error call client.get('test')\n{message}")
        metrics_fixture = {
            "test": [(1, .5), (2, .4)],
        }
    ...
    def test_client_get_not_exists(self):
        try:
            ...
            message = exp.args[0]
            self.fail(f"Error call client.get('key_not_exists')\n{message}")
